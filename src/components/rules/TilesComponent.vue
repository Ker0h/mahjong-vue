  ...
  <div class="row">
    <div class="col-12">
      ...
      <p>
        ...
        symbols. Hong Kong style Mahjong however, uses a set of 136 tiles. <br />
        Any set of Mahjong tiles consists of three suits: Bamboo, Characters, and Dots. With each
